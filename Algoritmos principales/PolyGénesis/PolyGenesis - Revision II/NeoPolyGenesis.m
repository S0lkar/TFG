...
function Solucion = NeoPolyGenesis(C, Segmento_Ignorado)
    ...
    for i = N-1:-1:2
        ...
        [Solucion] = Expandir_TSP(C, Solucion, EC, EC_pos, Segmento_Ignorado);
    end

    % Deberia asegurarme de que el primer punto sea el 1 siempre, por temas
    % de compatibilidades
end
